...
public class ProductComments {
    ...
    public ProductComments(String commId, String productId, String productName, String userId, int isAnonymous, int commType, String commContent, Date sepcName, int isShow) {
        this.commId = commId;
